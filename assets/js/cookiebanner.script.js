...
var headerScripts = [
  {
    ...
    type: "analytics",
    value:
      "<!-- Google tag (gtag.js) -->\n<script async src=\"https://www.googletagmanager.com/gtag/js?id=G-6P7PGL0N2V\"></script>\n<script>\n  window.dataLayer = window.dataLayer || [];\n  function gtag(){dataLayer.push(arguments);}\n  gtag('js', new Date());\n\n  gtag('config', 'G-6P7PGL0N2V');\n</script>",
  },
];
...
var config = {
  ...
  description:
    "Este sitio web utiliza cookies o tecnologías similares para mejorar su experiencia de navegación y ofrecerle recomendaciones personalizadas. Al continuar utilizando nuestro sitio web, acepta nuestra",
  acceptBtnLabel: "Aceptar",
  declineInfoBtnLabel: "Declinar",
  moreInfoBtnLink:
    "https://clientes.prodat.es/privacidad/MLG/m%C3%A1ximaabonos",
